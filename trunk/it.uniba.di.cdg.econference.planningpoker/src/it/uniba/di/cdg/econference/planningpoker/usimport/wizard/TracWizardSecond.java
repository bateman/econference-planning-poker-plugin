...
public class TracWizardSecond extends WizardPage implements MouseListener{

	public static Button enhancementButton, allButton;
	public static Button taskButton;
	public static Text otherText;
	String name="";
	public TracWizardSecond(){
		super("TracSecond");
		setTitle("Trac type of tickets");
		setDescription("Select type of tickets you want to import");
	}
	...
	public static LinkedList<String> grabType(){
		...
		if (TracWizardSecond.enhancementButton.getSelection()) type.offer("enhancement");
		if (TracWizardSecond.taskButton.getSelection()) type.offer("task");
		if (!TracWizardSecond.otherText.getText().equals("") && !TracWizardSecond.otherText.getText().equals("custom type..."))
			type.offer(TracWizardSecond.otherText.getText());
